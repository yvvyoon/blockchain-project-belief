...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ttmessage = (TextView) findViewById(R.id.message);
...
//        String tagId = new String(msgs[0].getRecords()[0].getType());
        ...
        new HttpAsyncTask().execute("http://70.12.224.38:9000/nfc?result=" + text);  //영찬이 IP
        //new HttpAsyncTask().execute("http://172.16.72.136:9000/nfc?result=" + text);  //재성이 vmWare
//        URL url = new URL("http://172.16.72.136:9000/nfc?result=" + text);
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String> {    //AsyncTask 상속을 날씨 정보를 비동기로 가져옴 <주소값, 중간표시 값, 결과 값>
        ...
        protected String doInBackground(String... params) { // HttpAsyncTask 클래스 생성시 알트+엔터로 만들기
            ...
            try {
                ...
                String message = object.getString("message"); //object 중 "time" 값을 time 에 저장
