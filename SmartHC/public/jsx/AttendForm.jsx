class AttendForm extends React.Component {
    send = () => {
        ...
        axios.post('/medical/attendFormInsertOne', data)
            .then((response) => {
                alert(response.data);
            ...
            <div style={main}>
                <div style={first}>
                    <form action="" method="post">
                        ...
                        <label style={label}>출입시간 :</label>
                        <input style={input} placeholder="1592999190" ref={ref => this.timestamp = ref} />
                        <label style={label}>출입유형코드 :</label>
                        <input style={input} placeholder="0" ref={ref => this.status = ref} />
...
ReactDOM.render(
    <AttendForm />,
    document.getElementById('react-attend-report-form')
);