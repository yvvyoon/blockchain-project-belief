    ...
    render(){     
        ...
        return (
            ...
            <div style={main}>
                ...
                <input style={input}  value="p003" ref={ref=>this.pcode=ref}/>
                <label style={label}>Name :</label>
                <input style={input}  value="Park" ref={ref=>this.name=ref}/>
                <label style={label}>주민등록번호 :</label>
                <input style={input}  value="901010-1010111" ref={ref=>this.ssn=ref}/>
                <label style={label}>주소 :</label>
                <input style={input}  value="Busan" ref={ref=>this.addr=ref}/>
                <label style={label}>Email :</label>
                <input style={input}  value="park@test.com" type="email" ref={ref=>this.email=ref}/>
                <label style={label}>진료일 :</label>
                <input style={input}  type="date" ref={ref=>this.visitDate=ref} />
                <label style={label}>상병부위 :</label>
                <input style={input}  value="hand" ref={ref=>this.desease=ref} />
                ...
                <textarea style={textarea}  value="hand shake..." 
